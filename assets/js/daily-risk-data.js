window.dailyRiskPageData = {
  ...
  reportData: [
...

    {
      ...
      matters:
        "Economic risk matters because it is the bridge between global events and everyday impact. A conflict headline can become a household cost through fuel, transport, food, electricity and borrowing conditions. This report is written to help search users understand why energy-route uncertainty, oil prices and shipping insurance are central to the daily global risk index."
    },

    {
      ...
      matters:
        "Health risk matters because outbreak response depends on speed and trust. Testing, isolation, safe burials, healthcare-worker protection, contact tracing and transparent public communication determine whether a regional emergency stays contained. This section also helps SEO by clearly explaining the difference between confirmed cases, suspected cases and pandemic-level risk."
    },

    {
      ...
      matters:
        "Climate risk matters because it weakens resilience across the whole system. When heat, drought or floods hit at the same time as energy-price stress or disease outbreaks, governments and markets have less room to absorb shocks. This report is expanded for SEO around global climate risk, El Niño, extreme heat and food-price pressure."
    }
  ],
